...
- <a name="footnote-4">4</a>: Block Media Format (BMF) — BRC-224 (composable on-chain audio/video; the multi-payee profile enforces payment to the creators of the components a BMF composition reuses).
