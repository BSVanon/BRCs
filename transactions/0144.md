...
- [BRC-131: Multicast Block Announcement Frame Format](./0131.md) — this object
  is what a BRC-131 `MsgType 0x01` announcement carries on the multicast fabric
- [BRC-135: Multicast Block Header Frame Format](./0135.md) — the header-only
  subset of this object, for consumers that need the chain and not the block
