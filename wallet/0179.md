...
rest are described but unguarded. An implementation SHOULD state which surfaces construct an
enforcer, because a reader counting declared capabilities will otherwise overcount what is enforced.
